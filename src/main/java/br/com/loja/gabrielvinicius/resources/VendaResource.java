...
public class VendaResource {
	...
	@GetMapping("")
	@Operation(summary = "Achar todas as Venda", description = "Achar todas as Venda",
	tags = {"Venda"}, responses = {
	...
	@GetMapping("/{codigo}")
	@Operation(summary = "Achar a Venda", description = "Achar a Venda",
	tags = {"Venda"}, responses = {
			@ApiResponse(description = "Sucesso", responseCode = "200", 
	...
	@PostMapping("/salvar")
	@Operation(summary = "Adcionar uma Nova Venda", description = "Adcionar uma Nova Venda",
	tags = {"Venda"}, responses = {
			@ApiResponse(description = "Sucesso", responseCode = "200", 
					content = @Content(schema = @Schema(implementation = Venda.class))),
			@ApiResponse(description = "Falha na Requisição", responseCode = "400", content = @Content),
	...
	@Operation(summary = "Atualizar dados da Venda", description = "Atualizar dados da Venda",
	tags = {"Venda"}, responses = {
